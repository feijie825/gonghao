...
//
//*****************************************************************************
#define NVIC_INT_TYPE           0xE000E004  // 中断控制类型寄存器
#define NVIC_ST_CTRL            0xE000E010  // 系统周期时钟控制和状态寄存器
#define NVIC_ST_RELOAD          0xE000E014  // 系统周期时钟重置寄存器
#define NVIC_ST_CURRENT         0xE000E018  // 系统周期时钟计数当前值寄存器	写清零
#define NVIC_ST_CAL             0xE000E01C  // 系统周期时钟校准寄存器 10ms
#define NVIC_EN0                0xE000E100  // IRQ 0 to 31 设置中断使能寄存器
#define NVIC_EN1                0xE000E104  // IRQ 32 to 63 设置中断使能寄存器
#define NVIC_DIS0               0xE000E180  // IRQ 0 to 31 清零中断使能寄存器
#define NVIC_DIS1               0xE000E184  // IRQ 32 to 63 清零中断使能寄存器
#define NVIC_PEND0              0xE000E200  // IRQ 0 to 31 中断请求寄存器 写0无效
#define NVIC_PEND1              0xE000E204  // IRQ 32 to 63 中断请求寄存器 写0无效
#define NVIC_UNPEND0            0xE000E280  // IRQ 0 to 31 中断清除寄存器 写0无效
#define NVIC_UNPEND1            0xE000E284  // IRQ 32 to 63 中断清除寄存器 写0无效
#define NVIC_ACTIVE0            0xE000E300  // IRQ 0 to 31 中断有效寄存器
#define NVIC_ACTIVE1            0xE000E304  // IRQ 32 to 63 中断有效寄存器
#define NVIC_PRI0               0xE000E400  // IRQ 0 to 3 中断优先级寄存器
#define NVIC_PRI1               0xE000E404  // IRQ 4 to 7 中断优先级寄存器
#define NVIC_PRI2               0xE000E408  // IRQ 8 to 11 中断优先级寄存器
#define NVIC_PRI3               0xE000E40C  // IRQ 12 to 15 中断优先级寄存器
#define NVIC_PRI4               0xE000E410  // IRQ 16 to 19 中断优先级寄存器
#define NVIC_PRI5               0xE000E414  // IRQ 20 to 23 中断优先级寄存器
#define NVIC_PRI6               0xE000E418  // IRQ 24 to 27 中断优先级寄存器
#define NVIC_PRI7               0xE000E41C  // IRQ 28 to 31 中断优先级寄存器
#define NVIC_PRI8               0xE000E420  // IRQ 32 to 35 中断优先级寄存器
#define NVIC_PRI9               0xE000E424  // IRQ 36 to 39 中断优先级寄存器
#define NVIC_PRI10              0xE000E428  // IRQ 40 to 43 中断优先级寄存器
#define NVIC_PRI11              0xE000E42C  // IRQ 44 to 47 中断优先级寄存器
