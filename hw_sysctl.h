...
//
//*****************************************************************************
#define SYSCTL_DID0             0x400FE000  // 器件标识寄存器 0
#define SYSCTL_DID1             0x400FE004  // 器件标识寄存器 1
