...
/*
 * RCS $Revision: 104266 $
 * Checkin $Date: 2006-11-02 15:31:41 +0000 (Thu, 02 Nov 2006) $
...
extern _ARMABI long int atol(u8 * /*nptr*/);
    ...
    */
#if !defined(__STRICT_ANSI__) || __USE_C99_STDLIB
extern _ARMABI __int64 atoll(u8 * /*nptr*/);
   /*
...
extern _ARMABI double strtod(u8 * __restrict /*nptr*/, char ** __restrict /*endptr*/);
   /*
    * converts the initial part of the string pointed to by nptr to double
    ...
    */
#if !defined(__STRICT_ANSI__) || __USE_C99_STDLIB
extern _ARMABI float strtof(u8 * __restrict /*nptr*/, char ** __restrict /*endptr*/);
extern _ARMABI long double strtold(u8 * __restrict /*nptr*/, char ** __restrict /*endptr*/);
   /*
    * same as strtod, but return float and long double respectively.
    */
#endif
extern _ARMABI long int strtol(u8 * __restrict /*nptr*/,
    ...
    */
extern _ARMABI unsigned long int strtoul(u8 * __restrict /*nptr*/,
                                       char ** __restrict /*endptr*/, int /*base*/);
   /*
...
extern _ARMABI __int64 strtoll(u8 * __restrict /*nptr*/,
                               char ** __restrict /*endptr*/, int /*base*/);
   /*
    ...
    * macro ERANGE is stored in errno.
    */
extern _ARMABI unsigned __int64 strtoull(u8 * __restrict /*nptr*/,
                                         char ** __restrict /*endptr*/, int /*base*/);
   /*
...
extern _ARMABI int atexit(void (* /*func*/)(void));
   /*
...
extern _ARMABI char *getenv(u8 * /*name*/);
   /*
...
extern _ARMABI int  system(u8 * /*string*/);
   /*
 ...
 */
extern _ARMABI int mblen(u8 * /*s*/, size_t /*n*/);
   /*
