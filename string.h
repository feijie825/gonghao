...
/*
 * RCS $Revision: 122681 $
 * Checkin $Date: 2007-01-18 11:57:51 +0000 (Thu, 18 Jan 2007) $
 */
...
extern _ARMABI void *memmove(void * /*s1*/,
    ...
    * Returns: the value of s1.
    */
extern _ARMABI char *strcpy(void * __restrict /*s1*/, void * __restrict /*s2*/);
   /*
    ...
    * Returns: the value of s1.
    */
extern _ARMABI char *strncpy(char * __restrict /*s1*/, char * __restrict /*s2*/, size_t /*n*/);
   /*
...
extern _ARMABI char *strcat(char * __restrict /*s1*/, const char * __restrict /*s2*/);
   /*
    ...
    * Returns: the value of s1.
    */
extern _ARMABI char *strncat(char * __restrict /*s1*/, const char * __restrict /*s2*/, size_t /*n*/);
   /*
...
extern _ARMABI int strcmp(const char * /*s1*/, const char * /*s2*/);
    ...
    */
extern _ARMABI int strncmp(const char * /*s1*/, const char * /*s2*/, size_t /*n*/);
   /*
    ...
    *          less than the string pointed to by s2.
    */
extern _ARMABI int strcoll(const char * /*s1*/, const char * /*s2*/);
   /*
...
extern _ARMABI size_t strxfrm(char * __restrict /*s1*/, const char * __restrict /*s2*/, size_t /*n*/);
   /*
...
extern _ARMABI size_t strcspn(const char * /*s1*/, const char * /*s2*/);
   /*
...
#ifdef __cplusplus
extern _ARMABI const char *strpbrk(const char * /*s1*/, const char * /*s2*/);
extern "C++" inline char *strpbrk(char * __s1, const char * __s2)
    { return const_cast<char *>(strpbrk(const_cast<const char *>(__s1), __s2)); }
#else
extern _ARMABI char *strpbrk(const char * /*s1*/, const char * /*s2*/);
#endif
   /*
...
#ifdef __cplusplus
extern _ARMABI const char *strrchr(const char * /*s*/, int /*c*/);
...
extern _ARMABI size_t strspn(const char * /*s1*/, const char * /*s2*/);
   /*
    * computes the length of the initial segment of the string pointed to by s1
...
#ifdef __cplusplus
extern _ARMABI const char *strstr(const char * /*s1*/, const char * /*s2*/);
extern "C++" inline char *strstr(char * __s1, const char * __s2)
    { return const_cast<char *>(strstr(const_cast<const char *>(__s1), __s2)); }
#else
extern _ARMABI char *strstr(const char * /*s1*/, const char * /*s2*/);
#endif
   /*
...
extern _ARMABI char *strtok(char * __restrict /*s1*/, const char * __restrict /*s2*/);
#ifndef __STRICT_ANSI__
extern _ARMABI char *strtok_r(char * /*s1*/, const char * /*s2*/, char ** /*ptr*/);
#endif
   /*
...
extern _ARMABI char *strerror(int /*errnum*/);
    ...
    */
extern _ARMABI size_t strlen(const char * /*s*/);
   /*
...
extern _ARMABI size_t strlcpy(char * /*dst*/, const char * /*src*/, size_t /*len*/);
   /*
...
extern _ARMABI size_t strlcat(char * /*dst*/, const char * /*src*/, size_t /*len*/);
   /*
