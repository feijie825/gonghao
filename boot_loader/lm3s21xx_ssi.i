...
#line 8 "LM3S21xx_ssi.c"
#line 9 "LM3S21xx_ssi.c"
#line 1 "disp.h"
...
#line 10 "LM3S21xx_ssi.c"


 
void Init_Ssi(void)
{
    SysCtlPeripheralEnable(((1<<8)|4 ));
    SSIConfigSetExpClk(((SSI_Typedef*)0x40008000),8000000,                            0x00000000,                            0x00000000,                            20000,                            0x00000007);    




    SSIEnable(((SSI_Typedef*)0x40008000));                           
}
...
void SSIDataLen(SSI_Typedef *SSIx,u8 Len)
{
    while(!(SSIx->SR & 0x00000001))
     { 
     }
    SSIx->CR0 = ((SSIx->CR0 & (~0x0000000F)) | Len); 
}
                                           ...
                                           u32 ulBitRate, u32 ulDataWidth)
{
    ...
    ulRegVal = (ulMode == 0x00000002) ? 0x00000008 : 0;
    ulRegVal |= (ulMode == 0x00000000) ? 0 : 0x00000004;
    SSIx->CR1 = ulRegVal;
