...
#define CRYSTAL_FREQ            8000000	 //系统晶振频率

#define SYS_TIME                1        //系统定时时间
...
#define BOOST_LDO_VOLTAGE	   //内核工作电压2.75V
...
#define APP_START_ADDRESS       0x00000C00	 //用于用户软件起始地址	1K倍数
...
//#define FLASH_RSVD_SPACE        0x00000400	//BOOTLOADER代码保护地址设置
...
#define FLASH_CODE_PROTECTION		 //FLASH代码保护允许
...
#define ENABLE_UPDATE_CHECK	   //允许升级检查(I/O管脚)
...
//
//*****************************************************************************
#define FORCED_UPDATE_PERIPH    SYSCTL_RCGC2_GPIOC	//定义强制升级管脚所在端口
...
//
//*****************************************************************************
#define FORCED_UPDATE_PORT      GPIOC	           //ZLZ2008.11.12改为PC.5 小显示KEYIN口
#define BOARD_ID_PORT           GPIOG              //板号ID
//*****************************************************************************
//
...
//#define	BOOT_UART1  1         //是否通过UART1升级
...
#define UART_FIXED_BAUDRATE     9600	//固定波特率
...
//
//*****************************************************************************
//#define I2C_SLAVE_ADDR     0x42	//I2C地址
...
//
//*****************************************************************************
//#define ENET_ENABLE_LEDS			//以太网状态灯使能
...
//
//*****************************************************************************
//#define ENET_MAC_ADDR0          0x00	 //以太网地址
