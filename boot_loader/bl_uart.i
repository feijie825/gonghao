...
UARTSend(const unsigned char *pucData, unsigned long ulSize)
{
    ...
    while(ulSize--)
    {
        ...
        while((((UART_Typedef*)0x4000C000)->FR & 0x00000020))
        {
        }
        ...
        ((UART_Typedef*)0x4000C000)->DR = *pucData++;
    }
...
UARTFlush(void)
{
    ...
    while(!(((UART_Typedef*)0x4000C000)->FR & 0x00000080))
    {
    }
    ...
    while((((UART_Typedef*)0x4000C000)->FR & 0x00000008))
    {
    }
}
...
UARTReceive(unsigned char *pucData, unsigned long ulSize)
{
    ...
    while(ulSize--)
    {
        ...
        while((((UART_Typedef*)0x4000C000)->FR & 0x00000010))
        {
        }
        ...
        *pucData++ = ((UART_Typedef*)0x4000C000)->DR;
    }
}
